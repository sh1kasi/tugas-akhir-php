...
<div class="dashboard">
    ...
    <div class="dashboard-body">
        ...
        <div class="sidebar-container">
            <div class="sidebar">
                <ul>
                    <li><a href="#"><i data-feather="user"></i> &nbsp; CRUD</a></li>
                </ul>
                <ul>
        ...
        <div class="login_container">
            <h2 class="login">Tambah User</h2>
            <div class="form">
                <form action="<?= BASE_URL . 'post/add_user_post.php' ?>" method="post" enctype="multipart/form-data">
                    <div class="username">
                        <label for="name" style="font-weight: bold">Nama</label> <br>
                        <input type="text" id="name" class="inputan" name="name" required style="width: 100%;">
                    </div>
                    ...
                    <div class="password_confirmation" style="margin-top: 15px;">
                        ...
                        <input type="password" required id="password_confirmation" class="inputan" name="password_confirmation" style="width: 100%;">
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $("#gambar").change(function (e) { 
            ...
            $("input[type=file]::after").css("content", fileName);
        });
